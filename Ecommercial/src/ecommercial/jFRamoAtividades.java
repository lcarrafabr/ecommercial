...
/*
 * jFRamoAtividades.java
 *
 * Created on 05/08/2012, 02:21:51
 */
 ...
 */
public class jFRamoAtividades extends javax.swing.JDialog {

    /** Creates new form jFRamoAtividades */
    public jFRamoAtividades() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        graderamoAtividadejTable = new javax.swing.JTable();
        jTabbedPane1 = new javax.swing.JTabbedPane();
        jPanel3 = new javax.swing.JPanel();
        jLabel1 = new javax.swing.JLabel();
        ramoatividadejTextField = new javax.swing.JTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ecommercial.EcommercialApp.class).getContext().getResourceMap(jFRamoAtividades.class);
        ...
        graderamoAtividadejTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        graderamoAtividadejTable.setName("graderamoAtividadejTable"); // NOI18N
        graderamoAtividadejTable.getTableHeader().setReorderingAllowed(false);
        graderamoAtividadejTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                graderamoAtividadejTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(graderamoAtividadejTable);
        graderamoAtividadejTable.getColumnModel().getColumn(0).setResizable(false);
        graderamoAtividadejTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        graderamoAtividadejTable.getColumnModel().getColumn(0).setHeaderValue(resourceMap.getString("graderamoAtividadejTable.columnModel.title0")); // NOI18N
        graderamoAtividadejTable.getColumnModel().getColumn(1).setResizable(false);
        graderamoAtividadejTable.getColumnModel().getColumn(1).setPreferredWidth(270);
        graderamoAtividadejTable.getColumnModel().getColumn(1).setHeaderValue(resourceMap.getString("graderamoAtividadejTable.columnModel.title1")); // NOI18N
        ...
        ramoatividadejTextField.setText(resourceMap.getString("ramoatividadejTextField.text")); // NOI18N
        ramoatividadejTextField.setName("ramoatividadejTextField"); // NOI18N
        ramoatividadejTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                ramoatividadejTextFieldKeyReleased(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(ramoatividadejTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(ramoatividadejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, 0, 427, Short.MAX_VALUE)
    ...
    int codRamoAtividade;


    //******************************************************************************************************
    public void getGradeRamoAtividade() throws ParseException{
       //Consultar pedidos
        RamoAtividades oRamoAtividade = new RamoAtividades();

        if ( ramoatividadejTextField.getText().length() > 0 ){
            oRamoAtividade.setRamo_atividade(ramoatividadejTextField.getText()+"%");
        }

        ResultSet resultSet = null;

        String[] colunasTabela = new String[]{"#Id", "Ramo Atividade"};
        ...
        graderamoAtividadejTable.setModel(modeloTabela);
        graderamoAtividadejTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        graderamoAtividadejTable.getColumnModel().getColumn(1).setPreferredWidth(270);
...
try {
            ...
            resultSet = oRamoAtividade.getConsultar();
            ...
            Logger.getLogger(RamoAtividades.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            ...
            while (resultSet.next()) {
                ...
                modeloTabela.addRow(new String[]{
                    Funcoes.getCodigoFormat(resultSet.getInt("COD_RAMO_ATIVIDADE")),
    ...
    public void getFieldRamoAtividade(int codRamoAtividade) throws ParseException{

        RamoAtividades oRamoAtividade = new RamoAtividades();
        ResultSet rs = null;
        oRamoAtividade.setCod_ramo_atividade(codRamoAtividade);
        ...
        try {
            ...
            //Pegar campos
            ramoatividadejTextField.setText(rs.getString("RAMO_ATIVIDADE"));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        ramoatividadejTextField.grabFocus();
        try {
            getGradeRamoAtividade();
        } catch (ParseException ex) {
            Logger.getLogger(jFRamoAtividades.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void novojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novojButtonActionPerformed
        ...
        ramoatividadejTextField.setText("");
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        // TODO add your handling code here:
            ...
            RamoAtividades oRamoAtividade = new RamoAtividades();
                ...
                oRamoAtividade.setRamo_atividade(ramoatividadejTextField.getText().trim().toUpperCase());
                oRamoAtividade.setCadastrar();
    ...
    private void salvarMaisjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarMaisjButtonActionPerformed
        // TODO add your handling code here:
        salvarMaisjButtonActionPerformed(null);
        novojButtonActionPerformed(null);
    }//GEN-LAST:event_salvarMaisjButtonActionPerformed

    private void graderamoAtividadejTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_graderamoAtividadejTableMouseClicked
        // TODO add your handling code here:
        editarjButton.setEnabled(true);
            codRamoAtividade = Integer.parseInt(graderamoAtividadejTable.getValueAt(graderamoAtividadejTable.getSelectedRow(), 0).toString());
            if (codRamoAtividade == 0) {
                return;
            }
        try {
            getFieldRamoAtividade(codRamoAtividade);
        } catch (ParseException ex) {
            Logger.getLogger(jFPaises.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_graderamoAtividadejTableMouseClicked
    ...
    private void alterarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarjButtonActionPerformed
        ...
        oRamoAtividade.setRamo_atividade(ramoatividadejTextField.getText().trim().toUpperCase());
        oRamoAtividade.setAlterar(conexao);
        try {
            ClassConecta.con.commit();
            ClassConecta.con.setAutoCommit(true);
        } catch (SQLException ex) {
    ...
    private void excluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirjButtonActionPerformed
        ...
        oRamoAtividade.setExcluir(conexao);
        try {
            ClassConecta.con.commit();
            ClassConecta.con.setAutoCommit(true);
        } catch (SQLException ex) {
    ...
    private void ramoatividadejTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ramoatividadejTextFieldKeyReleased
        // TODO add your handling code here:
        ...
        if (ramoatividadejTextField.getText().equals("")){
            ramoatividadejTextField.setText("");
            editarjButton.setEnabled(false);
        }
    }//GEN-LAST:event_ramoatividadejTextFieldKeyReleased
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFRamoAtividades().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable graderamoAtividadejTable;
    ...
    private javax.swing.JTextField ramoatividadejTextField;
