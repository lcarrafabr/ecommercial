...
/*
 * jFTipoFornecedor.java
 *
 * Created on 18/11/2012, 19:32:34
 */
 ...
 */
public class jFTipoFornecedor extends javax.swing.JDialog {

    /** Creates new form jFTipoFornecedor */
    public jFTipoFornecedor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tipoFornecedorjTextField = new javax.swing.JTextField();
        jLabel1 = new javax.swing.JLabel();
        grupojComboBox = new javax.swing.JComboBox();
        jLabel2 = new javax.swing.JLabel();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane2 = new javax.swing.JScrollPane();
        gradeTipoFornecedorjTable = new javax.swing.JTable();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ecommercial.EcommercialApp.class).getContext().getResourceMap(jFTipoFornecedor.class);
        ...
        jScrollPane1.setViewportView(obsjTextArea);
        ...
        tipoFornecedorjTextField.setText(resourceMap.getString("tipoFornecedorjTextField.text")); // NOI18N
        tipoFornecedorjTextField.setName("tipoFornecedorjTextField"); // NOI18N
        tipoFornecedorjTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tipoFornecedorjTextFieldKeyReleased(evt);
            }
        });
        ...
        grupojComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "GERAL", "CONTADOR", "ANALISTA", "CONVENIO" }));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tipoFornecedorjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel1))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel2)
                            .addComponent(grupojComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tipoFornecedorjTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        gradeTipoFornecedorjTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id#", "Tipo Fornecedor", "Grupo"
            }
        ) {
        ...
        gradeTipoFornecedorjTable.setName("gradeTipoFornecedorjTable"); // NOI18N
        gradeTipoFornecedorjTable.getTableHeader().setReorderingAllowed(false);
        gradeTipoFornecedorjTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gradeTipoFornecedorjTableMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(gradeTipoFornecedorjTable);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(0).setResizable(false);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(0).setHeaderValue(resourceMap.getString("gradeTipoFornecedorjTable.columnModel.title0")); // NOI18N
        gradeTipoFornecedorjTable.getColumnModel().getColumn(1).setResizable(false);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(1).setPreferredWidth(150);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(1).setHeaderValue(resourceMap.getString("gradeTipoFornecedorjTable.columnModel.title1")); // NOI18N
        gradeTipoFornecedorjTable.getColumnModel().getColumn(2).setResizable(false);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(2).setPreferredWidth(100);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(2).setHeaderValue(resourceMap.getString("gradeTipoFornecedorjTable.columnModel.title2")); // NOI18N
    ...
    ComboItem combo_tipo_fornecedor;

    public int cod_tipo_fornecedor;


    //******************************************************************************************************
    public void getGradeTiposFornecedores() throws ParseException{
       //Consultar tipos Fornecedores
        TipoFornecedores oTipoFornecedor = new TipoFornecedores();


        if ( tipoFornecedorjTextField.getText().length() > 0 ){
            oTipoFornecedor.setTipo_fornecedor(tipoFornecedorjTextField.getText()+"%");
        }

        ResultSet resultSet = null;

        String[] colunasTabela = new String[]{"#Id", "Tipo Fornecedor", "Grupo"};
        ...
        gradeTipoFornecedorjTable.setModel(modeloTabela);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(1).setPreferredWidth(150);
        gradeTipoFornecedorjTable.getColumnModel().getColumn(2).setPreferredWidth(100);

        gradeTipoFornecedorjTable.setDefaultRenderer(Object.class, new ColorRenderer());// DEIXA A GRADE ZEBRADA

try {


            resultSet = oTipoFornecedor.getConsultar();
            ...
            Logger.getLogger(TipoFornecedores.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            ...
            while (resultSet.next()) {
                ...
                modeloTabela.addRow(new String[]{
                    Funcoes.getCodigoFormat(resultSet.getInt("COD_TIPO_FORNECEDOR")),
    ...
    public void getFieldTipoFornecedor(int cod_tipo_fornecedor) throws ParseException{

        TipoFornecedores oTipoFornecedor = new TipoFornecedores();
        ResultSet rs = null;
        oTipoFornecedor.setCod_tipo_fornecedor(cod_tipo_fornecedor);

        try {
            rs = oTipoFornecedor.getConsultar();
            rs.next();

            ComboItem oItem = new ComboItem(rs.getInt("COD_TIPO_FORNECEDOR"), rs.getString("TIPO_FORNECEDOR"));
            grupojComboBox.setSelectedItem(oItem);

            //Pegar campos
            tipoFornecedorjTextField.setText(rs.getString("TIPO_FORNECEDOR"));
            grupojComboBox.setSelectedItem(rs.getString("GRUPO"));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        tipoFornecedorjTextField.grabFocus();
    ...
    private void novojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novojButtonActionPerformed
        ...
        tipoFornecedorjTextField.setText("");
        grupojComboBox.setSelectedItem("GERAL");
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        // TODO add your handling code here:
            ...
            if (tipoFornecedorjTextField.getText().equals("")){

                JOptionPane.showMessageDialog(null, "O campo TIPO FORNECEDOR é obrigatório", "ATENÇÃO Mensagem do Sistema", JOptionPane.INFORMATION_MESSAGE);
                return;

            }else{

            oTipoFornecedor.setTipo_fornecedor(tipoFornecedorjTextField.getText().trim().toUpperCase());
            oTipoFornecedor.setGrupo(grupojComboBox.getSelectedItem().toString());
            oTipoFornecedor.setObs(obsjTextArea.getText());
            oTipoFornecedor.setCadastrar();
        try {
    ...
    private void gradeTipoFornecedorjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gradeTipoFornecedorjTableMouseClicked
        // TODO add your handling code here:
        editarjButton.setEnabled(true);
            cod_tipo_fornecedor = Integer.parseInt(gradeTipoFornecedorjTable.getValueAt(gradeTipoFornecedorjTable.getSelectedRow(), 0).toString());
            if (cod_tipo_fornecedor == 0) {
                return;
            }
        try {
            getFieldTipoFornecedor(cod_tipo_fornecedor);
        } catch (ParseException ex) {
            Logger.getLogger(jFTipoFornecedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_gradeTipoFornecedorjTableMouseClicked

    private void tipoFornecedorjTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tipoFornecedorjTextFieldKeyReleased
        // TODO add your handling code here:
        if (!alterarjButton.isEnabled()){
            try {
                TipoFornecedores oTipoFornercedor = new TipoFornecedores();
                oTipoFornercedor.setTipo_fornecedor(tipoFornecedorjTextField.getText());
                ResultSet rs = null;
                rs = oTipoFornercedor.getConsultar();
                getGradeTiposFornecedores();
            } catch (ParseException ex) {
                Logger.getLogger(jFTipoFornecedor.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
    ...
    }//GEN-LAST:event_tipoFornecedorjTextFieldKeyReleased
    ...
    private void alterarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarjButtonActionPerformed
        ...
        oTipoFornecedor.setGrupo(grupojComboBox.getSelectedItem().toString());
        oTipoFornecedor.setObs(obsjTextArea.getText());
        oTipoFornecedor.setAlterar(conexao);
        try {
            ClassConecta.con.commit();
            ClassConecta.con.setAutoCommit(true);
        } catch (SQLException ex) {
    ...
    private void excluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirjButtonActionPerformed
        ...
        oTipoFornecedor.setExcluir(conexao);
        try {
            ClassConecta.con.commit();
            ClassConecta.con.setAutoCommit(true);
        } catch (SQLException ex) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFTipoFornecedor().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable gradeTipoFornecedorjTable;
    ...
    private javax.swing.JTextField tipoFornecedorjTextField;
